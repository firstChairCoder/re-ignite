...
import { command, direction, heading, link, p } from "../tools/pretty";
...
module.exports = {
  ...
  run: async (toolbox: GluegunToolbox) => {
    ...
    command(
      "rename          ",
      "Renames your React Native project (experimental)",
    ...
    command(
      "snackify        ",
      "Creates a new branch which can be imported as an Expo snack",
      ["ignite snackify"]
    );
    p();
    direction(
